...
var getWeather = {	
	fiveDay: function (location) {		
		return axios.get('https://crossorigin.me/http://api.openweathermap.org/data/2.5/forecast/daily?q=' + location + '&type=accurate&APPID=2a1dfced24bf88fa9d326596f4c84973&cnt=5')
			.then(function (res) {
				return res.data;
			})
			.catch(function (err) {
